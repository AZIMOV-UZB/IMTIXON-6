...
const Royxar = () => {
  return (
    <div className="continer mt-5 mb-12">
      <div className="w-[330px] sm:w-[400px] md:w-[400px] lg:w-[400px] border h-[403px] rounded-[5px] m-auto p-[15px] sm:p-[31px] md:p-[31px] lg:p-[31px] flex flex-col gap-[25.87px]">
